# CDMSS gate evidence — pass 2 SUPPLEMENTAL 3 (the final test repair), 17 August 2026

Authority: Saul review 31 as corrected by review 32. Addendum v20, signed by V over digest 487a045e8c1089d1c49bf899dbcd64f5a3fee0d8b085d098eb3bd7ad08ebe3e6, verified by one-line substitution.
The final test repair commit (commit 9): 0e0503b03946561d5cac233beb90243bc02e49f5
Gate run: 2026-08-17T09:30:03Z to 2026-08-17T09:31:48Z UTC, from commit 9.
Mutation table (the eighteen-row re-run set, rows 1-14 and 31-34) run BEFORE the gate, completed before commit 9 was
created; the gate then ran once, from commit 9.

Raw capture directory: $HOME/cdmss-pass2-gate-final-17-aug-2026
...
check, and both build-pair runs, the refusal included — as supplemental-2 did.
(The FIRST supplemental evidence lacked command-7 timestamps and the refusal
build's ENDED line; neither file is edited; this one claims only what it holds.)
...
## Part 1 — the mutation table: the eighteen-row re-run set, BEFORE the gate (addendum v20 §4)

Rows 1 to 14 and 31 to 34. Neither more nor fewer; rows 15 to 30 were not run (v20 §4.1).
Sandbox per kickoff v3 §9.1, shape verified (dotfiles and lib/ present, .git absent),
deleted after. cwd = worktree, test path = sandbox copy; no git command inside the sandbox.

### The byte-equality proof (v20 §4.2 / kickoff §5.1)

Hash 1 (worktree, before the table) · Hash 2 (sandbox baseline) · Hash 3 (worktree, after the
table) · Hash 4 (`git show HEAD:… | shasum -a 256` after commit 9):

```text
0f4e6461f848dfade6fb0b0116a7705507ec786f89875e13b93e715db06a0173  lib/__tests__/explicit-judge-equivalence.test.ts
0f4e6461f848dfade6fb0b0116a7705507ec786f89875e13b93e715db06a0173  /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/explicit-judge-equivalence.test.ts
0f4e6461f848dfade6fb0b0116a7705507ec786f89875e13b93e715db06a0173  lib/__tests__/explicit-judge-equivalence.test.ts
0f4e6461f848dfade6fb0b0116a7705507ec786f89875e13b93e715db06a0173  -
```

All four agree: 0f4e6461f848dfade6fb0b0116a7705507ec786f89875e13b93e715db06a0173.

⚠️ DISCLOSED: a FIRST pass over the same eighteen rows ran against an earlier byte-state of the
test file (hash c696961469f57acfe56181852344e909d03c3a9e05102c8fcb63475a63686d1c). All eighteen
discriminated in that pass too, but its row 34 surfaced the leak as `resetObservations refused:
1 request(s) in flight` from the cleanup rather than as the bounded wait's own named message
— a cleanup fault masking the body's error. The builder repaired 5.2c/5.2d so a cleanup fault
is swallowed when the body has already failed, and — because the test file changed — RE-RAN THE
ENTIRE eighteen-row set against the final bytes, per v20 §7 step 4 / v19 §7 step 4. The table
below is that final run. The superseded first-pass capture is preserved verbatim under
...
+++ /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/judge-server-stub.ts	2026-08-17 14:58:17
@@ -93,7 +93,7 @@
 }
...
```diff
--- /Users/vinaybhardwaj/dev/Even-CDMSS-rerank-telemetry/lib/__tests__/judge-server-stub.ts	2026-08-17 10:39:18
+++ /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/judge-server-stub.ts	2026-08-17 14:58:18
@@ -491,7 +491,7 @@
...
```diff
--- /Users/vinaybhardwaj/dev/Even-CDMSS-rerank-telemetry/lib/__tests__/judge-server-stub.ts	2026-08-17 10:39:18
+++ /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/judge-server-stub.ts	2026-08-17 14:58:19
@@ -483,7 +483,6 @@
...
```diff
--- /Users/vinaybhardwaj/dev/Even-CDMSS-rerank-telemetry/lib/__tests__/judge-server-stub.ts	2026-08-17 10:39:18
+++ /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/judge-server-stub.ts	2026-08-17 14:58:20
@@ -382,7 +382,7 @@
...
not ok 4 - 5.2b-fail — 5.2b's FAILURE PATH: when the acceptance wait rejects, the request is destroyed and awaited, the original wait error is preserved, and the NEXT shared-server request succeeds
```
...
```diff
--- /Users/vinaybhardwaj/dev/Even-CDMSS-rerank-telemetry/lib/__tests__/judge-server-stub.ts	2026-08-17 10:39:18
+++ /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/judge-server-stub.ts	2026-08-17 14:58:21
@@ -206,7 +206,7 @@
...
```diff
--- /Users/vinaybhardwaj/dev/Even-CDMSS-rerank-telemetry/lib/__tests__/judge-server-stub.ts	2026-08-17 10:39:18
+++ /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/judge-server-stub.ts	2026-08-17 14:58:22
@@ -427,11 +427,11 @@
...
# fail 1
# cancelled 0
# duration_ms 239.503584
```

### Row 33 (NEW, v20 §4) — the DATA HANDLER re-reads the live `recording` flag instead of `recordThisRequest`. Must fail: the oversized mid-flight toggle test 5.2d.
...
# fail 1
# cancelled 0
# duration_ms 239.791292
```

### Row 34 (NEW, v20 §4) — the CLOSE CALLBACK re-reads the live `recording` flag, exactly the review-32 diff. Must fail: 5.2c's bounded zero-in-flight assertion. RUN IN ISOLATION BY TEST NAME (--test-name-pattern), never as part of a whole-file run.

Mutation diff (worktree original vs mutated sandbox copy):

```diff
--- /Users/vinaybhardwaj/dev/Even-CDMSS-rerank-telemetry/lib/__tests__/judge-server-stub.ts	2026-08-17 10:39:18
+++ /Users/vinaybhardwaj/cdmss-pass2-sandbox/repo/lib/__tests__/judge-server-stub.ts	2026-08-17 14:58:43
@@ -356,7 +356,9 @@
...
ok 872 - 5.2b — MID-FLIGHT TOGGLE off→on: a request accepted while recording was off produces NO observation, and the in-flight count returns to zero
  ---
  duration_ms: 3.988458
  type: 'test'
  ...
# Subtest: 5.2b-fail — 5.2b's FAILURE PATH: when the acceptance wait rejects, the request is destroyed and awaited, the original wait error is preserved, and the NEXT shared-server request succeeds
ok 873 - 5.2b-fail — 5.2b's FAILURE PATH: when the acceptance wait rejects, the request is destroyed and awaited, the original wait error is preserved, and the NEXT shared-server request succeeds
  ---
  duration_ms: 14.149833
  type: 'test'
  ...
...
# [retrieval-telemetry] settlement rejected: no_row lvc_recall efd1d879-ba71-4fb5-a6e0-ce2a776eeae7
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall a37e2804-e221-4b7d-9bac-6e4cead9f806
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall a18645b9-7749-4dd2-81ec-5bacbe62afc8
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall fb0dc02c-0891-4463-a1b7-93be02c55e22
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall 85a74c63-b32b-4e7e-9162-67fec1bc6e8f
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall 9ced6664-57bc-4b56-96d6-a5d2f525a50a
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall 15dd67f6-33d2-4731-8b30-dc01493427c0
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall 22f1dc93-5104-4576-b892-7b5124e92704
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall 54962e87-f1d0-4c9b-b859-ae5018277ddd
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] semantic recall failed Invalid URL
# [retrieval-telemetry] terminal write rejected (revision or state moved) lvc_recall — row state unknown
# [retrieval-telemetry] settlement rejected: no_row lvc_recall 2fcaf694-6dbe-47e8-8737-ca9e1e2bf3a3
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
# [lvc] judge REFUSED (no_gemini_model_resolved): served 'none' != intended 'none' — every rec insufficient_info, no flag fires
...
ok 2275 - promResponsesToEncounter: deterministic (twice → deep-equal)
  ---
  duration_ms: 0.438792
  type: 'test'
  ...
# Subtest: versions
ok 2276 - versions
  ---
  duration_ms: 0.597416
  type: 'test'
  ...
...
# skipped 0
# todo 0
# duration_ms 21618.984792
--- end output ---
EXIT: 0
ENDED: 2026-08-17T09:30:25Z
```
...
```text
COMMAND: cp lib/architecture/map.generated.ts /Users/vinaybhardwaj/cdmss-pass2-gate-final-17-aug-2026/gen1.ts
STARTED: 2026-08-17T09:31:06Z
--- output (stdout+stderr merged) ---
--- end output ---
EXIT: 0
ENDED: 2026-08-17T09:31:06Z
...
```text
COMMAND: cmp lib/architecture/map.generated.ts /Users/vinaybhardwaj/cdmss-pass2-gate-final-17-aug-2026/gen1.ts
STARTED: 2026-08-17T09:31:06Z
--- output (stdout+stderr merged) ---
--- end output ---
EXIT: 0
...
```text
GATE START 2026-08-17T09:30:03Z at commit 0e0503b03946561d5cac233beb90243bc02e49f5
...
GATE END 2026-08-17T09:31:48Z
```

## Part 3 — evidence integrity

The six earlier evidence files, hashed at this pass, all pinned by addendum v20
§6.1 / review 32 — every one must match:
...
All six pinned digests match. No earlier evidence file, report, addendum or
review was edited in this round; addendum v19 stands unchanged with its false
signature line intact (review 31; v20 §1.1).
