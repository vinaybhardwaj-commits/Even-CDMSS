...
export const OPD_AUDIT_CHANGELOG: EngineChange[] = [
  {
    ...
    points: [
      ...
      'SCOPE: this clears the 4 in-scope ledger-visible signal types (drug_interaction, dose_ceiling_sos + reclassifies incomplete_dosing/duplicate_molecule) — it does NOT take uncited_deterministic to zero overall; the unverified_brand/off_formulary residue (~2,589) is the recommended next build (PRD §9.3), and lasa_pair is a separate defect build.',
    ],
